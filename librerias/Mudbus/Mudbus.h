...
#define MB_N_C_0x 0 //Max coils for Modbus is 2000 - dont need that many so here is a multiple of 8
#define MB_N_I_1x 0 //Max inputs for Modbus is 2000 - dont need that many so here is a multiple of 8
#define MB_N_IR_3x 124 //Max 16 bit input registers for Modbus is 125
#define MB_N_HR_4x 124 //Max 16 bit holding registers for Modbus is 125
#define MB_PORT 502
