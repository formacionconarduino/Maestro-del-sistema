...
#define CANT_IR_ESTADO 1 // Cantidad de registros de estado en los remotos

#define MAX_REMOTOS_RTU 116 //Número máximo de remotos RTU

#define TAMANO_COLA_RTU 10
...
byte colaRTU [TAMANO_COLA_RTU][4+RTU_NO_HR]; // cola de órdenes RTU (FIFO)
